...
public class D13ExcelWriteUsingDataProvider {
	File file;
  ...
  public void writeExcel(String u, String p) {
	  sheet.createRow(index).createCell(0).setCellValue(u);
	  sheet.getRow(index).createCell(1).setCellValue(p);
